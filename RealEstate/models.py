...
class ZipCodes(models.Model):
    """ Here are information about zip codes, which are stored in the Real_Estate_zipcodes table."""
...
class RealEstates(models.Model):
    """ Here are information about the real estate, which are stored in Real_Estate_realestates table.
...
class RealEstateImages(models.Model):
    """ Hera are iformation about real estate images, which are stored in the Real_Estate_realestateimages.
        Also retrieving information about the real estate (Real_Estate_realestates) that 'owns' the images
